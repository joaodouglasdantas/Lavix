...
1. Insights inteligentes (análise de tendências, alertas por categoria, metas mensais).
2. Importação de extrato bancário (CSV/OFX).
3. Exportação de relatórios (PDF/Excel).
4. Orçamentos por categoria.
5. Testes automatizados (RSpec + Capybara).

---

Feito com ♥ para decisões rápidas.
